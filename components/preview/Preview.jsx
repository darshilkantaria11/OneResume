        ...
        <DragDropContext onDragEnd={onDragEnd}>
          <div className="f-col items-center mb-1">
            {resumeData.profilePicture.length > 0 && (
              <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-blue-900">
                <Image
              ...
              {resumeData.socialMedia.map((socialMedia, index) => {
                return (
                  <a
                    ...
                    style={{
                      display: "grid",
                      gridTemplateColumns: "min-content 1fr", // Ensure icon and text are in separate columns
                      gap: "0.25rem", // Adjust the gap between icon and text
                    }}
                  >
                    ...
                    <span style={{ overflowWrap: "break-word" }}>{socialMedia.link}</span>
                  </a>
                );
              })}
            </div>
